...
// JS WORKERS
gulp.task('workers:app', function() {
    log('Building workers..');
    // copy js worker for recordmp3
    return gulp.src('modules/audio/recorderWorker.js')
        .pipe(gulp.dest(build.scripts));
});
...
gulp.task('watch', function() {
  ...
  gulp.watch(source.scripts,         ['scripts:app', 'workers:app']);
